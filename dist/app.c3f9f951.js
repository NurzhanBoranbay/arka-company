...
var burger = document.querySelector('.header__click');
var nav = document.querySelector('.nav');
var footer = document.querySelectorAll('.footer__list');
var showFooter = document.querySelectorAll('.list__link');
